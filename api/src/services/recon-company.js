...
// Perplexity sonar is primary (real-time web). Gemini 2.5 Flash is fallback if Perplexity
// returns thin content or fails (estate-converged version — CONTROL/models.catalog.json
// role sense-web). Silent if neither key is present.
//
