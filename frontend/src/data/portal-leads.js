const ALL_VENDORS = ['crowdstrike','trellix','trendmicro','sophos','vanta','drata','secureframe','trustwave','okta','cisco_duo','microsoft','rsa','palo_alto','fortinet','cloudflare','sonicwall','veeam','cohesity','veritas','netapp','proofpoint','opentext','keeper','jamf','nutanix','aws','austbrokers'];
...
export const TENANTS = {
  ...
  vanta: {
    ...
    vendors: ['vanta','drata','secureframe'],
  },
  cisco: {
    name: 'Cisco',
    short: 'CI',
    ...
    vendors: ['cisco_duo','palo_alto','fortinet'],
  },
  austbrokers: {
    name: 'Austbrokers CyberPro',
    short: 'CP',
    domain: 'austbrokers.com.au',
    color: '#10b981',
  ...
  aws: {
    ...
    role: 'vendor',
    tagline: 'Cloud Security & Infrastructure',
    vendors: ['aws'],
  },
  okta: {
    name: 'Okta',
  ...
  ingram: {
    ...
    role: 'distributor',
    tagline: 'AU Distributor · Full catalog view',
    vendors: ['trellix','sophos','fortinet','palo_alto','cohesity','nutanix','proofpoint','keeper','jamf'],
  },
};
...
const GAP_VENDOR_MAP = {
  ...
  cyber_insurance:    ['austbrokers'],
  cloud_security:     ['aws','cloudflare'],
};
...
const VENDOR_NAMES = {
  ...
  palo_alto: 'Palo Alto Networks', fortinet: 'Fortinet', cloudflare: 'Cloudflare', sonicwall: 'SonicWall',
  veeam: 'Veeam', cohesity: 'Cohesity', veritas: 'Veritas', netapp: 'NetApp',
  proofpoint: 'ProofPoint', opentext: 'OpenText', keeper: 'Keeper',
  jamf: 'Jamf', nutanix: 'Nutanix', aws: 'AWS', austbrokers: 'Austbrokers CyberPro',
};
