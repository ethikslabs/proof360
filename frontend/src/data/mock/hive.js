export const HIVE_STAGES = [
...

  {
    ...
    panel: {
      ...
      aws: {
        summary: "Eight AWS programs. Most founders don't know you can apply for Activate and the Global Startup Program before you're on AWS. Five programs are locked — but three are available right now.",
        programs: [
          { name: 'AWS Activate',                   status: 'available',    value: 'Up to $25k credits via portfolio org',  detail: 'Shopify stack qualifies at this tier — no AWS infra required',    url: 'https://aws.amazon.com/activate'                                },
          { name: 'AWS Global Startup Program',     status: 'available',    value: 'Technical mentorship + $25k credits',   detail: 'Seed stage qualifies · apply before infrastructure migration',   url: 'https://aws.amazon.com/startups/startup-programs'               },
          { name: 'Well-Architected Review',        status: 'eligible',     value: 'Free architecture review',              detail: 'Available once blockchain layer begins AWS migration'                                                                                  },
          { name: 'AWS ISV Accelerate',             status: 'not_enrolled', value: 'Co-sell with AWS field reps',           detail: 'Locked — requires AWS footprint + Marketplace listing'                                                                               },
          { name: 'Foundational Technical Review',  status: 'not_enrolled', value: 'Pre-market security clearance',         detail: 'Unlocks at Stage 3 after AWS infrastructure migration'                                                                               },
          { name: 'AWS Marketplace Seller',         status: 'not_enrolled', value: '300k+ enterprise buyer channel',        detail: 'Unlocks when blockchain protocol migrates to AWS'                                                                                     },
          { name: 'AWS Partner Network — ISV Track',status: 'not_enrolled', value: 'Advanced partner discounts + MDF',      detail: 'Two validated customer references required'                                                                                           },
          { name: 'Migration Acceleration Program', status: 'not_enrolled', value: 'Up to 25% AWS cost offset',             detail: 'Applicable when blockchain layer migrates — plan now'                                                                                 },
        ],
      },
      microsoft: {
        ...
        programs: [
          ...
          { name: 'Ingram Micro AMP — Azure Assessment',  status: 'available',    value: 'Free Azure migration assessment',                     detail: 'Free via Ingram ANZ · no Azure footprint needed',             url: 'https://www.ingrammicro.com/en-AU/services/microsoft'                 },
          ...
          { name: 'Microsoft AI Cloud Partner Program',   status: 'eligible',     value: 'Azure OpenAI Service credits + support',              detail: 'AI workload qualifies · partner designation required',        url: 'https://partner.microsoft.com'                                        },
          { name: 'Azure Marketplace — Transact Listing', status: 'not_enrolled', value: '10% marketplace reward on transactions',              detail: 'Phase 2 — after Founders Hub onboarding and scale',           url: 'https://partner.microsoft.com/en-us/partnership/azure-marketplace'    },
        ],
      },
      posture: {
...

  {
    ...
    spaces: {
      ...
      aws:       { lit: true, sub: '8 programs', persona: 'edison',   msg: "Eight AWS programs mapped. Four active or in-progress. Moving to AWS unlocked the co-sell motion — $175k+ in credits and marketplace reach that was completely locked at Stage 2. The gap between Stage 2 and Stage 3 on AWS alone is worth more than most seed rounds." },
      microsoft: { lit: true, sub: '6 programs', persona: 'leonardo', msg: "Six Microsoft programs matched. Founders Hub covers Azure migration cost. Ingram AMP assessment is free now. The Marketplace listing is the Phase 2 play — 10% reward on every transaction through the channel." },
    ...
    panel: {
      ...
      aws: {
        summary: "Eight programs. Four active or in-progress. Moving to AWS unlocked the co-sell motion — $175k+ in credits and marketplace reach that was completely locked at Stage 2.",
        programs: [
          { name: 'AWS Activate',                   status: 'available',    value: '$25k credits active',                  detail: 'Blockchain infra qualifies · credits live now',                    url: 'https://aws.amazon.com/activate'                                },
          { name: 'Well-Architected Review',        status: 'available',    value: 'Free provenance API review',           detail: 'Schedule now via Solutions Architect',                            url: 'https://aws.amazon.com/architecture/well-architected'           },
          { name: 'AWS Global Startup Program',     status: 'available',    value: 'Technical mentorship + $25k credits',  detail: 'On-chain architecture qualifies for extended engagement',         url: 'https://aws.amazon.com/startups/startup-programs'               },
          ...
          { name: 'AWS ISV Accelerate',             status: 'eligible',     value: 'Co-sell with AWS field reps',          detail: 'APN membership active · Marketplace listing in progress',         url: 'https://aws.amazon.com/partners/programs/isv-accelerate'        },
          { name: 'AWS Marketplace Seller',         status: 'eligible',     value: '300k+ enterprise buyers',              detail: 'Protocol listing setup in progress · SaaS listing',              url: 'https://aws.amazon.com/marketplace/management'                  },
          { name: 'AWS Partner Network — ISV Track',status: 'not_enrolled', value: 'Advanced partner discounts + MDF',     detail: 'Two validated customer references required'                                                                                          },
          { name: 'Migration Acceleration Program', status: 'not_enrolled', value: 'Up to 25% cost offset',                detail: 'Projected workload approaching minimum threshold'                                                                                    },
        ],
      },
      microsoft: {
        summary: "Six Microsoft programs matched. Founders Hub covers the Azure infrastructure cost. The Ingram AMP assessment is free and available right now — fastest path to funded cloud.",
        programs: [
          ...
          { name: 'GitHub Copilot for Business',          status: 'available',    value: 'Free via Founders Hub',                               detail: 'Included · activate in GitHub after Hub onboarding',          url: 'https://github.com/features/copilot'                                  },
          { name: 'Ingram Micro AMP — Azure Assessment',  status: 'available',    value: 'Free Azure assessment + migration planning',           detail: 'Free via Ingram ANZ · no Azure footprint needed',             url: 'https://www.ingrammicro.com/en-AU/services/microsoft'                 },
          ...
          { name: 'Microsoft AI Cloud Partner Program',   status: 'eligible',     value: 'Azure OpenAI credits + technical support',            detail: 'AI workload qualifies · partner designation required',        url: 'https://partner.microsoft.com'                                        },
          { name: 'Azure Marketplace — Transact Listing', status: 'not_enrolled', value: '10% marketplace reward on all transactions',          detail: 'Phase 2 — after Founders Hub onboarding + Series A',          url: 'https://partner.microsoft.com/en-us/partnership/azure-marketplace'    },
        ],
      },
      posture: {
