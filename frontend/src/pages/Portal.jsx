...
export default function Portal() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#07090f', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "var(--p360-sans)", position: 'relative', overflow: 'hidden', padding: '40px 16px' }}>
      <style>{`
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 460, background: 'rgba(255,255,255,0.03)', backdropFilter: 'blur(20px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, padding: '36px 36px 32px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {/* Google / Microsoft render ONLY when their OAuth client id is baked in.
              Neither is configured in prod today, so both stay hidden rather than shipping a
              dead greyed-out control; if an id is later baked from SSM the button returns
